<?php
     ...
     require_once("../config/conexion.php");
      ...
      class Compras extends Conectar{
        ...
        public function get_compras_por_id($id_compras){
             ...
             $sql="select * from compras where id_compras=? and id_usuario=?";
      ...
      public function numero_compra(){
		    ...
		    $sql="select numero_compra from detalle_compras where id_usuario=?;";
  	  ...
  	  public function agrega_detalle_compra(){
           ...
           ay dos formas de hacer esto:
         ,. Es la más fácil, que es dentro del bucle 
         ...
         */
           ...
           //$fecha_compra= date("d/m/Y");
            ...
            $sql5="select sum(importe) as total from detalle_compras where numero_compra=? and id_usuario=?;";
      ...
      public function get_detalle_proveedor($numero_compra){
          ...
          and
          c.numero_compra=? and c.id_usuario=? and p.id_usuario=?
      ...
      public function get_detalle_compras_proveedor($numero_compra){
       ...
       $conectar=parent::conexion();
          ...
          d.numero_compra=?
          and
          d.id_usuario=? and c.id_usuario=? and p.id_usuario=?
      ...
      public function cambiar_estado($id_compras, $numero_compra, $est){
       ...
       //declaro $numero_compra, viene via ajax
        ...
        $sql="update compras set 
          ...
          $sql2="select * from detalle_compras where numero_compra=? and id_usuario=?";
      ...
      public function lista_busca_registros_fecha($fecha_inicial, $fecha_final){
            ...
            $sql= "SELECT * FROM compras WHERE fecha_compra>=? and fecha_compra<=? and id_usuario=?";
      ...
      public function lista_busca_registros_fecha_mes($mes, $ano){
          ...
          $sql= "SELECT * FROM compras WHERE fecha_compra like ? and id_usuario=?";
      ...
      public function get_compras_por_id_proveedor($id_proveedor){
        ...
        $sql="select * from compras where id_proveedor=? and id_usuario=?";
      ...
      public function get_detalle_compras_por_id_proveedor($id_proveedor){
       ...
       $sql="select * from detalle_compras where id_proveedor=? and id_usuario=?";
      ...
      public function get_compras_reporte_general(){
       ...
       //hacer la consulta que seleccione la fecha de mayor a menos
        ...
        FROM compras where id_usuario=? and estado='1' GROUP BY YEAR(fecha_compra) desc, month(fecha_compra) desc";
     ...
     //suma el total de compras por año
      ...
      public function suma_compras_total_ano(){
       ...
       $conectar=parent::conexion();
        ...
        $sql="SELECT YEAR(fecha_compra) as ano,SUM(total) as total_compra_ano, moneda FROM compras where id_usuario=? and estado='1' GROUP BY YEAR(fecha_compra) desc";
     ...
     //suma total por año 
      public function suma_compras_total_grafica(){
       ...
       $sql="SELECT YEAR(fecha_compra) as ano,SUM(total) as total_compra_ano FROM compras where estado='1' and id_usuario=? GROUP BY YEAR(fecha_compra) desc";
      ...
      public function suma_compras_canceladas_total_grafica(){
       ...
       $sql="SELECT YEAR(fecha_compra) as ano,SUM(total) as total_compra_ano FROM compras where estado='0' and id_usuario=? GROUP BY YEAR(fecha_compra) desc";
      ...
      public function suma_compras_anio_mes_grafica($fecha){
       ...
       //SI EXISTE EL ENVIO POST ENTONCES SE MUESTRA LA FECHA SELECCIONADA
        if(isset($_POST["year"])){
          ...
          $sql="SELECT YEAR(fecha_compra) as ano, MONTHname(fecha_compra) as mes, SUM(total) as total_compra_mes FROM compras WHERE YEAR(fecha_compra)=? and estado='1' and id_usuario=? GROUP BY MONTHname(fecha_compra) desc";
      ...
      public function get_year_compras(){
        ...
        $conectar=parent::conexion();
          ...
          $sql="select year(fecha_compra) as fecha from compras where id_usuario=? group by year(fecha_compra) asc";
      ...
      public function get_compras_mensual($fecha){
        ...
        $sql="select MONTHname(fecha_compra) as mes, MONTH(fecha_compra) as numero_mes, YEAR(fecha_compra) as ano, SUM(total) as total_compra, moneda
        from compras where YEAR(fecha_compra)=? and estado='1' and id_usuario=? group by MONTHname(fecha_compra) asc";
      ...
      public function get_pedido_por_fecha($cedula,$fecha_inicial,$fecha_final){
            ...
            $sql="select * from detalle_compras where cedula_proveedor=? and fecha_compra>=? and fecha_compra<=? and estado='1' and id_usuario=?;";
      ...
      public function get_cant_productos_por_fecha($cedula,$fecha_inicial,$fecha_final){
           ...
           $sql="select sum(cantidad_compra) as total from detalle_compras where cedula_proveedor=? and fecha_compra >=? and fecha_compra <=? and estado = '1' and id_usuario=?;";
      ...
      public function get_compras_anio_actual(){
            ...
            $sql="SELECT YEAR(fecha_compra) as ano, MONTHname(fecha_compra) as mes, SUM(total) as total_compra_mes, moneda FROM compras WHERE YEAR(fecha_compra)=YEAR(CURDATE()) and estado='1' and id_usuario=? GROUP BY MONTHname(fecha_compra) desc";
      ...
      public function get_compras_anio_actual_grafica(){
           ...
           $sql="SELECT  MONTHname(fecha_compra) as mes, SUM(total) as total_compra_mes FROM compras WHERE YEAR(fecha_compra)=YEAR(CURDATE()) and estado='1' and id_usuario=? GROUP BY MONTHname(fecha_compra) desc";
